...
/// It's okay to have several [Logger] instances writing to the same channel. A good practise is
/// to create one [Logger] per source file.
///
/// Usage example:
/// ```
...
/// ```
///
/// Messages are only processed if they are of the same (or a higher) importance as the
/// configured one, please refer to the [LogLevel] class for a description of the available
/// levels. See the [LogConfiguration] class for information about configuring the log output.
class Logger {
...
/// This class is the entry point for configuring the log output. It is a singleton because
/// there is only one global log configuration which applies to all created [Logger]s.
class LogConfiguration {
  // The global singleton instance.
  static final LogConfiguration _singletonInstance =
