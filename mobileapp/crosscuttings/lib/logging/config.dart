...
enum LogLevel {
  ...
  /// Something unexpected happened or a problem might occur in the near future, but the software
  /// is still working as expected.
  warning,

  /// Information that things are working as expected.
  info,

  /// Detailed information, typically only of interest to a developer trying to diagnose a problem.
  debug,

  /// Most verbose information that go even beyond the debug scope, e.g. for tracing single function
  /// calls.
  trace,
