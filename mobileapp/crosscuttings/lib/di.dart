...
/// ```
///
/// This class is not a singleton but all instances share the same DI configuration, so they can
/// be created on demand as needed. Most system parts will only ever need the [provide()]
/// method.
class DependencyProvider {
  ...
  /// The [instanceFactory] is a functor that must return a new instance of [T]. It will be
  /// called at any time, at the latest when the instance requested via [provide()]. Any
  /// previously registered implementation is discarded.
  ///
