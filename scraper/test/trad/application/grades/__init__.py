"""
Code that is used by both grade parser test implementations, to avoid code duplication.
"""
...
"""
Pairs of grade labels and their parsed SaxonGrade counterparts that are expected to work with both
parser implementations. To be used as part of a test parametrization list.
"""


def ensure_parser_resuability(parser: GradeParser) -> None:
    """
    Ensures that the given `parser` can be reused, i.e. resets its internal state (if any) for each
    call.
    """
